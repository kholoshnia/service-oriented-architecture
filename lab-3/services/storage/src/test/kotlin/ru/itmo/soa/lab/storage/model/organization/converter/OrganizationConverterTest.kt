...
class OrganizationConverterTest {
    ...
    fun `should return same organization given organization dto`() {
        ...
        assertThat(organizationDto.coordinates.x).isEqualTo(organization.coordinates.x)
        assertThat(organizationDto.coordinates.y).isEqualTo(organization.coordinates.y)
    }
