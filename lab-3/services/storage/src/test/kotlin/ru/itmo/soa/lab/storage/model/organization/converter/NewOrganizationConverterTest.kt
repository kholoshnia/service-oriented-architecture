...
class NewOrganizationConverterTest {
    ...
    fun `should return same organization given new organization dto`() {
        ...
        assertThat(organization.coordinates.x).isEqualTo(newOrganizationDto.coordinates.x)
        assertThat(organization.coordinates.y).isEqualTo(newOrganizationDto.coordinates.y)
    }
